...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `wishlist` WHERE in_id = '$delete_id'") or die('query failed');
   mysqli_query($conn, "DELETE FROM `cart` WHERE in_id = '$delete_id'") or die('query failed');
...
<section class="show-instruments">
   ...
   <div class="box-container">
      ...
      <?php
         $select_instruments = mysqli_query($conn, "SELECT * FROM `instruments`") or die('query failed');
